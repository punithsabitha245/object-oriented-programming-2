...
if __name__ == '__main__':
    books = ['Python', 'Rich Dad Poor Dad', 'Harry Potter', 'C++ Basics', 'Algorithms by CLRS']
    sonali = Library(books, "Let's Upskill")
    _user_name = input("Welcome to our library! Please enter your name: ")

    while True:
        print(_user_name)
        print(
            f"\nHello {_user_name}, welcome to the {books.name} library. Please choose an option:"
        )
        print(
            "1. Display Books\n2. Lend a Book\n3. Add a Book\n4. Return a Book\n5. Quit"
        )
        ...
        if user_choice == '1':
            ...
            books.lendBook(_user_name, book)
        elif user_choice == '3':
